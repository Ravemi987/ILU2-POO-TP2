	...
	public void acheterProduit(String nomAcheteur) {
		if (!controlAcheterProduit.isAcheteur(nomAcheteur)) {
			...
			if (vendeursProduit == null) {
				...
				int nbProduit = Clavier.entrerEntier("Bonjour " + nomAcheteur + ". Combien de " + produit + " voulez-vous acheter ?");
				...
				if (quantite == 0) {
					...
					System.out.println(nomAcheteur + " veut acheter " + nbProduit + " " + produit + ", malheureusement " + vendeur
							+ " n'en a plus que " + quantite + ". " + nomAcheteur + " achète tout le stock de " + vendeur + ".");
				} else {
